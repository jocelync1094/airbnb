...
export class StayDetailInfoButton extends React.Component {
    state = {
      ...
      render() {
        const { stay } = this.props; //this stay matches the stay property when we passed in this as props
        const { name, description, address, guest_number } = stay; //more destructuring from stay props
